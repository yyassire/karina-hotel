...
<div class="container-sm">
    <div class="swiffy-slider slider-item-reveal slider-nav-round slider-item-ratio slider-item-ratio-32x9" id="slider1">
        <ul class="slider-container" style="width: 100%;">
            <li><img src="<?php echo e(asset('assets/img/karinnahotel/9.jpg')); ?>" loading="lazy" alt="..." class="img-fluid w-100"></li>
            <li><img src="<?php echo e(asset('assets/img/karinnahotel/9.jpg')); ?>" loading="lazy" alt="..." class="img-fluid w-100"></li>
            <li><img src="<?php echo e(asset('assets/img/karinnahotel/9.jpg')); ?>" loading="lazy" alt="..." class="img-fluid w-100"></li>
            <li><img src="<?php echo e(asset('assets/img/karinnahotel/9.jpg')); ?>" loading="lazy" alt="..." class="img-fluid w-100"></li>
        </ul>
    ...
    <div class="row">
        <div class="col-md-4 col-12 mb-4">
            <div class="card align-items-start justify-content-start border-0 shadow-sm hover:shadow-lg hover:translate-y-1">
                <img height="30" src="<?php echo e(asset('assets/img/icon/diamond.svg')); ?>" class="ms-3" alt="Card Image">
                <div class="card-body">
        ...
        <div class="col-md-4 col-12 mb-4">
            <div class="card align-items-start justify-content-start border-0 shadow-sm hover:shadow-lg hover:translate-y-1">
                <img height="30" src="<?php echo e(asset('assets/img/icon/point.svg')); ?>" class="ms-3" alt="Card Image">
                <div class="card-body">
        ...
        <div class="col-md-4 col-12 mb-4">
            <div class="card align-items-start justify-content-start border-0 shadow-sm hover:shadow-lg hover:translate-y-1">
                <img height="30" src="<?php echo e(asset('assets/img/icon/offer.svg')); ?>" class="ms-3" alt="Card Image">
                <div class="card-body">
        ...
        <div class="col-md-6 col-12 mb-4">
            <div class="card align-items-start justify-content-start border-0 shadow-sm hover:shadow-lg hover:translate-y-1">
                <img height="30" src="<?php echo e(asset('assets/img/icon/mobile-payment.svg')); ?>" class="ms-3" alt="Card Image">
                <div class="card-body">
        ...
        <div class="col-md-6 col-12 mb-4">
            <div class="card align-items-start justify-content-start border-0 shadow-sm hover:shadow-lg hover:translate-y-1">
                <img height="30" src="<?php echo e(asset('assets/img/icon/housekeeper.svg')); ?>" class="ms-3" alt="Card Image">
                <div class="card-body">
...
<?php /**PATH C:\MAMP\htdocs\karinnahotel.com\resources\views/guest/about/index.blade.php ENDPATH**/ ?>