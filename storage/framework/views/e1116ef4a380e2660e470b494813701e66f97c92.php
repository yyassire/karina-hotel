    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 text-center text-md-start">
                <img src="<?php echo e(asset('assets/img/footer-logo2.svg')); ?>" alt="Logo" class="img-fluid mb-3"
                ...
                <p><img class="me-2" src="<?php echo e(asset('assets/img/icon/Home.svg')); ?>" alt="">İkinci Gelişim Bölgesi Uludağ
                    – Bursa</p>
                <p>
                    <a href="https://www.google.com/maps?q=Karinna+Hotel" target="_blank"
                       style="color: white; text-decoration: none;">
                        <img class="me-2" src="<?php echo e(asset('assets/img/icon/global 1.svg')); ?>" alt="Harita Ikonu">Harita’da
                        Görüntüle
                    </a>
                </p>
            </div>
            ...
            <div class="col-md-5 d-flex flex-column justify-content-center align-items-center text-center">
                ...
                <div class="row mt-5">
                    <div class="col-md-6 d-flex flex-column align-items-center ">
                        ...
                        <a href="<?php echo e(url('standart-deluxe-oda')); ?>"
...
<?php /**PATH C:\Projects\html\karina-hotel\resources\views/guest/includes/footer.blade.php ENDPATH**/ ?>