...
<div class="container">
    <p class="text-title ms-4 my-4">
        ...
        >
        <a href="<?php echo e(url('reservation')); ?>" class="text-decoration-none text-custom">
            >Rezervasyon
        </a>
        >
        <a href="<?php echo e(url('reservation-list')); ?>" class="text-decoration-none text-custom">
            Liste
        </a>
        >
        <a href="<?php echo e(url('karinnahotel')); ?>" class="text-decoration-none text-custom">
            Karinna Hotel
        </a>
        >
        <a href="<?php echo e(url('standart-deluxe-oda')); ?>" class="text-decoration-none text-custom">
            Standart Oda
        </a>
        >
            ...
            <div class="card-body" id="reservationCard">
                <div class="row mb-3">
                    <div class="col-12 col-md-3">
                        ...
                        <img src="<?php echo e(asset('assets/img/karinnahotel/8.png')); ?>" class="img-fluid" alt="Oda Resmi">
                    </div>
                    <div class="col-12 col-md-3">
...
<?php /**PATH C:\Projects\html\karina-hotel\resources\views/guest/control-screen/index.blade.php ENDPATH**/ ?>