    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-4 mt-5">
                <div
                    class="card align-items-start justify-content-start border-0 shadow-sm hover:shadow-lg hover:translate-y-1 footer text-white mt-3">
                    <div class="card-body">
                        <p class="text-white fs-2 fw-semibold font-family-Barlow text-uppercase  m-0 px-3 py-2">Karİnna
                            Hotel</p>
                        <p class="text-white fs-6 fw-medium font-family-Barlow  m-0 px-3 py-2 ">İletişim Bilgileri</p>
                        <div class="m-0 px-3 py-2">
                            <p><img class="me-2" src="<?php echo e(asset('assets/img/icon/Message.svg')); ?>"
                                    alt="">info@tkarinnahotel.com </p>
                            <p><img class="me-2" src="<?php echo e(asset('assets/img/icon/Calling.svg')); ?>" alt="">+90
                                549 790 47 18 </p>
                            <p><img class="me-2" src="<?php echo e(asset('assets/img/icon/Home.svg')); ?>" alt="">İkinci
                                Gelişim Bölgesi Uludağ – Bursa</p>
                        </div>

                        <div class="ms-5">
                            <a class="contact-icons" href="https://www.facebook.com" target="_blank">
                                <i class="fab fa-facebook me-5"></i>
                            </a>
                            <a class="contact-icons" href="https://www.twitter.com" target="_blank">
                                <i class="fab fa-twitter me-5"></i>
                            </a>
                            <a class="contact-icons" href="https://www.instagram.com" target="_blank">
                                <i class="fab fa-instagram me-5"></i>
                            </a>
                            <a class="contact-icons" href="https://www.youtube.com" target="_blank">
            ...
            <div class="col-md-8 mb-3">
                ...
                <p class="text-secondary fs-6 fw-medium font-family-Barlow m-0 px-3 py-2">Bu formu kullanarak bizimle
                    iletişime geçin, size en kısa sürede ulaşacağız.</p>
                <div class="p-4 rounded">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <input type="tel" class="form-control" id="phone" placeholder="Telefon Numarası"
                                required>
                        </div>
                        <div class="col-md-6 mb-3">
    ...
    <div class="container">
        <div class="col-md-12 mb-3">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe
                    src="https://www.google.com/maps?q=Karinna%20Hotel%20Uluda%C4%9F%20Kirazl%C4%B1%20Uluda%C4%9F%202.%20B%C3%B6lge%2C%2016190%20Osmangazi%2FBursa%2C%20Türkiye&output=embed"
...
<?php /**PATH C:\Projects\html\karina-hotel\resources\views/guest/contact/index.blade.php ENDPATH**/ ?>