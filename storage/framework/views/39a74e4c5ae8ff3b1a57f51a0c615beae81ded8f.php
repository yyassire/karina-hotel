    ...
    <div class="row">
        <div class="col-md-7">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <!-- Featured Image -->
                <img src="<?php echo e(asset('storage/' . $room->featured_image)); ?>" class="img-fluid" alt="Oda Resmi">
                ...
                <p class="mt-5 mb-4 text-center fs-5 text-custom">
                    <img height="40" class="me-3 ms-3" src="../assets/img/icon/hand.svg" alt=""><?php echo e($room->price_per_night); ?>/Gecelik
                    <img height="40" class="me-3 ms-3" src="../assets/img/icon/bed.svg" alt=""> <?php echo e($room->bed_count); ?> Yatak
                    <img height="40" class="me-3 ms-3" src="../assets/img/icon/bathtub.svg" alt=""><?php echo e($room->bathroom_count); ?>
                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <img src="<?php echo e($room->images); ?>" alt="Fotoğraf 1" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-5">
            <p class="fs-6 text-custom mt-3"><?php echo e($room->price_per_night); ?>/Gecelik</p>
