...
<div class="video-background">
    <?php $__currentLoopData = $titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <iframe
            src="<?php echo e($title->video_url); ?>?autoplay=1&mute=1&loop=1&playlist=<?php echo e($title->video_url); ?>&controls=0&rel=0&modestbranding=1&iv_load_policy=3"
...
<div class="container-hotel text-center text-white d-flex flex-column justify-content-end my-5" style="min-height: 55vh;">
    <?php $__currentLoopData = $titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <h1 id="headline" class="fw-400 my-3 writing d position-relative hidden ">
            ...
            <?php echo e($title->title); ?> <br>
        </h1>
        <p id="paragraph" class="text-dark hidden mt-3">
            <?php echo e($title->subtitle); ?>
...
<?php /**PATH C:\Projects\html\karina-hotel\resources\views/guest/index.blade.php ENDPATH**/ ?>