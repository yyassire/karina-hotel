        ...
        <div class="row">
            ...
            <div class="col-md-5 d-flex flex-column justify-content-center align-items-center text-center">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 d-flex flex-column align-items-center">
                        <a href="{{ url('contact') }}" class="text-white mb-3 text-decoration-none">İletişim</a>
                        <a href="{{ url('gallery') }}" class="text-white mb-3 text-decoration-none">Galeri</a>
                        <a href="{{ url('foresthome') }}" class="text-white mb-3 text-decoration-none">Orman Evleri</a>
                    </div>
                </div>
            </div>
