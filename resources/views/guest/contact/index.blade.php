...
<body>
                ...
                <div
                    ...
                    <div class="card-body">
                        ...
                        <div class="m-0 px-3 py-2">
                            <p><img class="me-2" src="{{ asset('assets/img/icon/Message.svg') }}"
                                    alt="">info@tkarinnahotel.com </p>
                            <p><img class="me-2" src="{{ asset('assets/img/icon/Calling.svg') }}" alt="">+90
                                549 790 47 18 </p>
                            <p><img class="me-2" src="{{ asset('assets/img/icon/Home.svg') }}" alt="">İkinci
    ...
    @include('guest.includes.footer') <!-- Footer componentini dahil et -->
