                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Sayfa Detay Düzenle</h3>
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ url('/admin/page_detail/edit/' . $data->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hood_tr" class="form-control" value="{{$data['hood_tr']}}" >
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hood_en" class="form-control" value="{{$data['hood_en']}}">
                                            </div>
