        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Sayfa Detay Galeri Yönetimi</h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <form method="post" action="{{route('admin.page_detail_gallery.store')}}" enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="page_detail_id" value="{{$id}}">
                            ...
                            @foreach($data as $val)
                                <tr data-priority="{{$val['id']}}">
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-danger btn-sm" href="{{url('/admin/page_detail_gallery/delete/'.$val->id.'/'.$id)}}">
        ...
        $(function(){
            ...
            function setPriority() {
                $("#priority-list tr").each( function(i){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ URL::route('admin.page_detail_gallery.ajaxdesk') }}",
