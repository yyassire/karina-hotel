                                ...
                                @foreach ($data as $val)
                                    <tr data-priority="{{ $val['id'] }}">
                                        ...
                                        <td class="project-actions text-right">
                                            ...
                                            {{-- <a class="btn btn-primary btn-sm" href="{{route('admin.blog_detail.index',['id'=>$val['id']])}}">
                                            <i class="fas fa-plus">
                                            </i>
                                            Detay
                                        </a> --}}
                                            ...
                                            <a class="btn btn-warning btn-sm"
                                                href="{{ route('admin.blog_gallery.index', ['id' => $val['id']]) }}">
                                                <i class="fas fa-plus">
                                                </i>
                                                Galeri
                                            </a>
                                            ...
                                            <a class="btn btn-success btn-sm"
                                                href="{{ route('admin.blog.edit', ['id' => $val['id']]) }}">
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                                Düzenle
                                            </a>
                                            <a class="btn btn-danger btn-sm"
                                                href="{{ route('admin.blog.delete', ['id' => $val['id']]) }}"
        ...
        $(function() {
            ...
            function setPriority() {
                $("#priority-list tr").each(function(i) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ URL::route('admin.blog.ajaxdesk') }}",
                        headers: {
