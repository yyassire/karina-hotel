            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <form method="post" action="{{route('admin.ormanevleri-room_gallery.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            @foreach($data as $val)
                                <tr data-priority="{{$val['id']}}">
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-danger btn-sm" href="{{url('/admin/ormanevleri-room_gallery/delete/'.$val->id.'/'.$id)}}" onclick="return confirm('Silmek İstediğinizden Emin Misiniz ?')">
        ...
        $(function(){
            ...
            function setPriority() {
                $("#priority-list tr").each( function(i){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ URL::route('admin.ormanevleri-room_gallery.ajaxdesk') }}",
