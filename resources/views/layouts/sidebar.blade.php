    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 " style="display: grid; text-align: center;">
            <div class="image" style="padding-left: 0 !important;">
                <img src="/{{ \Illuminate\Support\Facades\Auth::user()->image }}"style="width: 75px; height: 75px;"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
              ...
              {{--
                ...
                <li class="nav-item">
                    <a href="/admin/slider_category" class="nav-link">
                        <i class="nav-icon fas fa-table"></i>
                        <p>
                            Slider Kategori Yönetimi
                        </p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.tkd.index') }}" class="nav-link">
                        <i class="nav-icon far fa-envelope"></i>
                        <p>
                            Tkd Yönetimi
                        </p>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.ormanevleri-room.index') }}" class="nav-link">
                    <i class="nav-icon fas fa-table"></i>
                    <p>
            ...
            <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.ormanevleri-contact.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sayfa Yönetimi</p>
                            </a>
                        </li>
