...
class CreateOrmanevleriContactsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ormanevleri_contacts', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ormanevleri_contacts');
    }
}
